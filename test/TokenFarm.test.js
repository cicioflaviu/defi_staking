...
contract('TokenFarm', ([owner, investor]) => {
    ...
    describe('Farming tokens', async () => {
        ...
        it('rewards investors for staking mDai tokens', async () => {
            ...
            // Check investor balance after tokens were issued
            result = await dappToken.balanceOf(investor)
            assert.equal(result.toString(), tokens('100'), 'investor DApp balance correct after issuing tokens')

            // Make sure that the owner is the only one who can issue tokens
            ...
            result = await tokenFarm.stakingBalance(investor)
            assert.equal(result.toString(), tokens('0'), 'investor DApp balance correct after unstaking')
